...
var statuses = __webpack_require__(3)
...
const getString = __webpack_require__(141);
...
var cors = __webpack_require__(134);
const serverless = __webpack_require__(136);
const app = express();
const bodyParser = __webpack_require__(31);
const feeds = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../feeds.json\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var query = [];
...
router.get('/', (req, res) => {
    ...
    if (req.query.text) {
        ...
        filteredFeeds = filteredFeeds.filter(function (feed) {
            if (feed.site.toLowerCase().indexOf(text) > -1 || feed.category.toLowerCase().indexOf(text) > -1 || feed.title.toLowerCase().indexOf(text) > -1 || feed.author.toLowerCase().indexOf(text) > -1) {
                return true;
            } else {
                return false;
            }
...
var parseUrl = __webpack_require__(17)
var resolve = __webpack_require__(2).resolve
var send = __webpack_require__(129)
var url = __webpack_require__(26)
...
const getHandler = __webpack_require__(137);
const dispatch = __webpack_require__(146);
...
const finish = __webpack_require__(139);
const getBody = __webpack_require__(140);
const isBinary = __webpack_require__(144);
